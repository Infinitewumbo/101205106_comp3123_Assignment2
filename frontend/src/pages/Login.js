    ...
    return (
        <Container className="d-flex justify-content-center align-items-center" style={{ minHeight: "100vh" }}>
            <Card style={{ width: '400px' }} className="shadow-lg">
                <Card.Header className="bg-blue-gradient text-center py-3">
                    <h3 className="mb-0 text-white">Welcome Back</h3>
                </Card.Header>
                <Card.Body className="p-4">
                    ...
                    <div className="mt-3 text-center">
                        <small>Don't have an account? <Link to="/signup" className="fw-bold">Sign Up</Link></small>
                    </div>
                </Card.Body>
            </Card>
        </Container>
